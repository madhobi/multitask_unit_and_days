...
filepaths = {
    'parent_data_folder': '../../data_inpatient_los20/',    
    'bf_folder':'bedflow/',
    'bf_prefix':'bedflow_with_daily_med_encoded_year_',
    'bf_filetype':'.pickle',    
    'pdemo_folder':'pdemos/',
    'pdemo_file_prefix':'pdemos_adult_year_',
    'pdemo_filetype':'.pickle',
    'pid_folder':'pdemos/',
    'pid_file_prefix':'pdemo_nonencoded_inpatient_hid2000_',
    'pid_filetype':'.pickle',
    'diag_filename':'encoded_diagnosis_all_inpatient_hid2000.pickle',
